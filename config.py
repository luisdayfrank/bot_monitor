...
class Config(BaseModel):
    ...
    # Grid params base
    grid_min_grids: int = 10             # CAMBIO: antes 5. Alineado con grid_niveles_min más bajo (memecoin=10)
    ...
    # ═══════════════════════════════════════════════════════════════════════════════
    # CAMBIO: grid_niveles_max aumentados drásticamente en cada perfil.
    # Valores originales entre paréntesis: memecoin 5, altcoin_bajo_vol 6, major 8, default 6
    perfiles_moneda: dict = {
        'memecoin': {
            'adx_min': 12.0,
            'volume_threshold': 0.30,
            'mfm_penalizacion_max': 3,
            'grid_niveles_max': 25      # antes: 5
        },
        'altcoin_bajo_vol': {
            'adx_min': 13.0,
            'volume_threshold': 0.40,
            'mfm_penalizacion_max': 5,
            'grid_niveles_max': 25      # antes: 6
        },
        'major': {
            'adx_min': 15.0,
            'volume_threshold': 0.70,
            'mfm_penalizacion_max': 7,
            'grid_niveles_max': 40      # antes: 8
        },
        'default': {
            'adx_min': 14.0,
            'volume_threshold': 0.50,
            'mfm_penalizacion_max': 5,
            'grid_niveles_max': 35      # antes: 6
        }
    }
